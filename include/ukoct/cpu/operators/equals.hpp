#ifndef UKOCT_CPU_OPERATORS_EQUALS_HPP_
#define UKOCT_CPU_OPERATORS_EQUALS_HPP_

#include "ukoct/cpu/operators/abstract.hpp"

#define ukoct_OPERCODE ukoct::OPER_EQUALS
...
template <typename T> class EqualsCpuOperator;

template <typename T> struct OperationImpl<T, ukoct_OPERCODE> {
	static constexpr bool valid = true;
	typedef EqualsCpuOperator<T> Impl;
	typedef T Type;
