#ifndef UKOCT_CPU_OPERATORS_UNION_HPP_
#define UKOCT_CPU_OPERATORS_UNION_HPP_

#include "ukoct/cpu/operators/abstract.hpp"

#define ukoct_OPERCODE ukoct::OPER_UNION
...
template <typename T> class UnionCpuOperator;

template <typename T> struct OperationImpl<T, ukoct_OPERCODE> {
	static constexpr bool valid = true;
	typedef UnionCpuOperator<T> Impl;
	typedef T Type;
